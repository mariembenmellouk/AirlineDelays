...
output_file_path = "C:/Users/merie/OneDrive/Bureau/WGU/D602/Task2/d602-deployment-task-2/ML_Project/formatted_data.csv"
df.to_csv(output_file_path, index=False)

print("Formatted data saved to:", output_file_path)

# Track the dataset with DVC
subprocess.run(["dvc", "add", output_file_path])

print("DVC push completed and data tracked.")
