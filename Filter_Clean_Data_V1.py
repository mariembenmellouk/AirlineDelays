...
output_file_path = "C:/Users/merie/OneDrive/Bureau/WGU/D602/Task2/d602-deployment-task-2/ML_Project/cleaned_filtered_data.csv"
df_filtered.to_csv(output_file_path, index=False)

print("Cleaned and filtered data saved to:", output_file_path)
